        ...
        <div className="bg-white rounded-3xl shadow-xl p-12 md:p-16 space-y-8">
          ...
          <div className="space-y-6 text-lg md:text-xl text-slate-600 leading-relaxed">
            <p>
              ...
              <span className="font-bold text-slate-900"> te come la preocupación</span>.
            </p>
            
            <p>
              Sabes que necesita <span className="font-semibold text-blue-600">ejercicio adaptado y fisioterapia profesional</span>, 
