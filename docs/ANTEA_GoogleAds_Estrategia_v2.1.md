...
> 1. Las 6 landings YA tienen formulario en el hero → se pueden activar los 6 ad groups.
> 2. Copy ajustado: "especializado en personas mayores" (no "exclusivamente").
> 3. Captación SOLO por formulario: eliminada la extensión de llamada, la conversión
>    de teléfono y los CTA "Llama al 633…". (Se mantiene WhatsApp porque su wizard es
>    un formulario que guarda el lead.)

---

## 0. ESTADO DE LANDING PAGES (revisado hoy)

Todas las landings tienen formulario en el hero (nombre + teléfono + botón). Listas para Ads.
...
| /recuperar-autonomia-mayores-madrid | ✅ Listo | ✅ Activar ya |
| /ejercicio-personas-mayores-madrid | ✅ Listo | ✅ Activar ya |
| /ejercicio-mayores-madrid-capital | ✅ Listo | ✅ Activar ya |

> Alternativa de mayor conversión: existen además landings dedicadas sin menú ni
> distracciones en `/ads/prevencion-caidas`, `/ads/recuperacion-postoperacion` y
> `/ads/ejercicio-mayores` (solo formulario, `noindex`). Puedes apuntar los ad groups
> a estas si prefieres páginas 100% de captación.
...
> Nota: NO se configura conversión de clic en teléfono. La captación es solo por
> formulario (y wizard de WhatsApp). El teléfono no se muestra en la web.
...
D3: Graduado en Ciencias del Deporte con 14 años especializado en personas
    mayores. Más de 200 familias en Madrid ya confían en ANTEA Salud.
...
D4: No hacemos clases genéricas. Cada programa es específico: fuerza en piernas,
    ...
    Solicita tu valoración gratuita sin compromiso.
```
...
D3: Más de 200 familias madrileñas confían en ANTEA Salud. Graduado en Ciencias
    del Deporte con 14 años especializado en personas mayores.
...
D4: El 70% de nuestros clientes reduce su miedo a caer en las primeras 6 semanas.
    ...
    disponibles este mes. Solicita tu valoración gratuita.
```
...
```
Estado:       ACTIVAR YA (formulario en hero ya disponible)
...
D4: He visto a personas de 85 años volver a salir solas a la calle tras 3 meses
    ...
    y te digo con sinceridad qué podemos conseguir. Primera valoración gratuita.
```
...
D4: Fuerza en piernas, equilibrio, movilidad articular y confianza al caminar.
    ...
    Si no ves resultados, no sigues. Solicita tu valoración gratuita.
```
...
D3: Graduado en Ciencias del Deporte con 14 años especializado en personas
    mayores en Madrid. Más de 200 familias confían en ANTEA Salud.
    Primera valoración gratuita y sin compromiso.
...
D4: No hacemos clases genéricas. Primero valoramos, luego diseñamos el programa,
    ...
    sesión, no sigues. Solicita tu valoración gratuita.
```
...
D3: Graduado en Ciencias del Deporte. 14 años especializado en personas
    mayores. Más de 200 familias en Madrid confían en ANTEA Salud.
...
D4: Prevención de caídas, recuperación post-operación o mantenimiento activo.
    ...
    Si no ves valor desde el principio, no sigues. Solicita tu valoración gratuita.
```
...
D4: Prevención de caídas, recuperación post-operación o mantenimiento activo.
    ...
    desde el principio, no sigues. Solicita tu valoración gratuita.
```
...
```
NO USAR. La captación es solo por formulario; no se ofrece teléfono.
```
...
### FASE 0 — Hoy mismo (las 6 landings ya tienen formulario)
```
✅ Configurar las 2 conversiones en Google Ads (formulario y WhatsApp) — sin teléfono
✅ Activar Ad Group 1: Prevención de caídas → /prevencion-caidas-mayores-madrid
✅ Activar Ad Group 2: Recuperar autonomía → /recuperar-autonomia-mayores-madrid
✅ Activar Ad Group 3: Fitness general → /ejercicio-personas-mayores-madrid
...
✅ Añadir todas las extensiones de anuncio (SIN extensión de llamada)
✅ Añadir keywords negativas globales
```

> Recomendación de control de gasto: aunque las 6 están listas, puedes arrancar con
> los 3 ad groups de mayor intención (1 caídas, 5 Móstoles, 6 Getafe) los primeros
> días y activar 2, 3 y 4 a las 48-72h, para vigilar el CPL sin dispersar presupuesto.

### FASE 1 — A los 14 días de datos
```
...
### FASE 2 — Cuando haya 20 conversiones acumuladas
```
