...
description: Checklist de seguridad pre-deploy. Auth/sesiones, RLS, env vars, CORS y headers, validación Zod, Stripe webhooks, Claude API, dependencias, rate limiting, GDPR. Usar antes de cada deploy o al revisar seguridad.
---
